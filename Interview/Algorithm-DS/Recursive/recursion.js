...
console.timeEnd()
// 耗时default: 0.0341796875ms

// 3. 其他方法：array.reduce()
var array =  new Array(100).fill().map((item,index)=>index+1); // => [1, 2, 3, ..., 99, 100]
console.time()
var total = array.reduce((total,cur)=>total+cur,0)
console.timeEnd()
// default: 0.02197265625ms

// 4. 高斯 等差数列求和公式 n（1+n）/2  100(100+1)/2 = 5050 详见./高斯.md
/**
 * 递归例1===========================================end
 */
...
function getSpread(arr) {
    ...
    console.log(spread(nestArr)) // [1, 12, 2, "abc", 888, 5, 6, 9]
}
getSpread(nestArr)
