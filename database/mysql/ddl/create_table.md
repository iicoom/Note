...
1. Table names are lower case, uses underscores to separate words, and are singular \(e.g. 'foo', 'foo\_bar', etc.
2. I generally \(not always\) have a auto increment PK. I use the following convention: tablename\_id \(e.g. 'foo\_id', 'foo\_bar\_id', etc.\).
3. FK\(foreign key\) [https://stackoverflow.com/questions/36373735/mysql-table-and-column-naming-convention](https://stackoverflow.com/questions/36373735/mysql-table-and-column-naming-convention)
